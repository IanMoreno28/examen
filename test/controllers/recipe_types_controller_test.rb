...
class RecipeTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_type" do
    assert_difference('RecipeType.count') do
      post recipe_types_url, params: { recipe_type: { descrption: @recipe_type.descrption, name: @recipe_type.name } }
    end
  ...
  test "should update recipe_type" do
    patch recipe_type_url(@recipe_type), params: { recipe_type: { descrption: @recipe_type.descrption, name: @recipe_type.name } }
